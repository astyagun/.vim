...
let s:base2   = ['#c6deff', s:cuicolors.base2[s:cuiindex]]
let s:base3   = ['#ffffff', s:cuicolors.base3[s:cuiindex]]
let s:yellow  = ['#e79e00', s:cuicolors.yellow[s:cuiindex]]
...
let s:green   = ['#479900', s:cuicolors.green[s:cuiindex]]
let s:gray    = ['#efefef', s:cuicolors.base02[s:cuiindex]]
...
let s:p.inactive.left = [ [ s:base3, s:base02 ] ]
let s:p.inactive.right = [ [ s:base03, s:base00 ], [ s:base3, s:base02 ] ]
...
let g:lightline#colorscheme#custom_solarized#palette = lightline#colorscheme#flatten(s:p)
